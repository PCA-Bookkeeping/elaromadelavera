...
const sections: Array<{ title: Record<Language, string>; text: Record<Language, string> }> = [
  ...
  },
  {
    ...
    text: { es: "El proceso de compra se realiza a través de nuestra tienda online. Al realizar un pedido, recibirás una confirmación por email con los detalles de tu compra.", en: "The purchase process is done through our online store. When you place an order, you'll receive an email confirmation with your purchase details.", pl: "Proces zakupu odbywa się za pośrednictwem naszego sklepu internetowego. Po złożeniu zamówienia otrzymasz potwierdzenie e-mailem ze szczegółami zakupu.", de: "Der Kaufvorgang erfolgt über unseren Online-Shop. Bei Bestellung erhalten Sie eine E-Mail-Bestätigung mit Ihren Kaufdetails.", fr: "Le processus d'achat s'effectue via notre boutique en ligne. Lors de la commande, vous recevrez une confirmation par e-mail avec les détails de votre achat.", pt: "O processo de compra é realizado através da nossa loja online. Ao efetuar uma encomenda, receberá uma confirmação por email com os detalhes da sua compra.", it: "Il processo di acquisto avviene tramite il nostro negozio online. Effettuando un ordine, riceverai una conferma via email con i dettagli del tuo acquisto.", nl: "Het aankoopproces verloopt via onze online winkel. Wanneer u een bestelling plaatst, ontvangt u een e-mailbevestiging met uw aankoopgegevens." },
  },
  {
  ...
  },
  {
    ...
    text: { es: "Los pedidos se procesan en 1-3 días laborables.", en: "Orders are processed within 1-3 business days.", pl: "Zamówienia są realizowane w ciągu 1-3 dni roboczych.", de: "Bestellungen werden innerhalb von 1-3 Werktagen bearbeitet.", fr: "Les commandes sont traitées sous 1 à 3 jours ouvrables.", pt: "As encomendas são processadas em 1-3 dias úteis.", it: "Gli ordini vengono elaborati entro 1-3 giorni lavorativi.", nl: "Bestellingen worden binnen 1-3 werkdagen verwerkt." },
  },
  {
